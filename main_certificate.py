...
from push_emails_to_participants import *
...
ambassador_name = "Venkata Sridhar Sai Kalavalapalli"

# get participants
list_participants = get_participants(participate_file);

# process data
create_docx_files(certificate_file, list_participants, ambassador_name)

#push emails

push_emails_to_participants(list_participants)
